...
def data_get():
    ...
    data = requests.get("https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=2c4af8e9cf6c1d8cf306be4050be0711").json()
...
win = Tk()
win.title("Jyoti weather App")
win.config(bg = "sky blue")
win.geometry("500x570")


name_label = Label(win, text= " Jyoti Weather App",font=("Time New Roman",30,"bold"))
...
com = ttk.Combobox(win,text="wscube weathe app",values=list_name, font = ("Time New Roman",15,"bold italic"), textvariable=city_name )
